      ...
      <div className="flex min-h-screen">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-3 border-b border-border bg-panel px-4 py-2 lg:hidden">
            <Button variant="ghost" aria-label="Mở điều hướng" title="Mở điều hướng" aria-expanded={mobileOpen} aria-controls="mobile-cms-nav" className="h-11 w-11 shrink-0 px-0" onClick={openMobileNavigation}><Menu aria-hidden="true" size={20} strokeWidth={1.8} /></Button>
