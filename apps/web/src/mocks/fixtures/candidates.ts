...
export const candidateFixtures: Candidate[] = [
  candidate({ id: 'candidate-09', code: 'UV-0009', name: 'Phạm Thu Hà', industryLabels: ['Điều dưỡng', 'Dịch vụ lưu trú'], occupation: 'Chăm sóc người cao tuổi', japaneseLevel: 'N4', recordStatus: 'ACTIVE', readinessStatus: 'READY_FOR_REVIEW', contactabilityStatus: 'CONTACTABLE', operationalPhase: 'POTENTIAL', owner: recruiter, lastActivityAt: '2026-08-15T03:00:00.000Z', nextAction: 'Sàng lọc hồ sơ', applicationCount: 0, hasActiveJourney: false, emailMasked: 'p***@example.com', phoneMasked: '09******12', source: 'Giới thiệu nội bộ', isPossibleDuplicate: false }),
  candidate({ id: 'candidate-01', code: 'UV-0001', name: 'Nguyễn Minh An', industryLabels: ['Công nghệ thông tin'], occupation: 'Phát triển phần mềm', japaneseLevel: 'N3', recordStatus: 'ACTIVE', readinessStatus: 'READY_FOR_INTERVIEW', contactabilityStatus: 'CONTACTABLE', operationalPhase: 'APPLYING', owner: recruiter, lastActivityAt: '2026-08-12T03:00:00.000Z', nextAction: 'Theo dõi lịch phỏng vấn', applicationCount: 1, hasActiveJourney: false, emailMasked: 'n***@example.com', phoneMasked: '09******01', source: 'Nguồn chủ động', isPossibleDuplicate: false }),
  candidate({ id: 'candidate-07', code: 'UV-0007', name: 'Lê Hoàng Yến', industryLabels: ['Công nghệ thông tin', 'Kinh doanh'], occupation: 'BrSE', japaneseLevel: 'N2', recordStatus: 'ACTIVE', readinessStatus: 'READY_FOR_INTERVIEW', contactabilityStatus: 'CONTACTABLE', operationalPhase: 'PASSED', owner: coordinator, lastActivityAt: '2026-08-09T09:00:00.000Z', nextAction: 'Theo dõi lộ trình cung ứng', applicationCount: 1, hasActiveJourney: true, emailMasked: 'l***@example.com', phoneMasked: '09******07', source: 'Ứng tuyển trực tiếp', isPossibleDuplicate: false }),
  candidate({ id: 'candidate-05', code: 'UV-0005', name: 'Võ Thanh Tùng', industryLabels: ['Công nghệ thông tin'], occupation: 'Kỹ sư phần mềm', japaneseLevel: 'N3', recordStatus: 'ACTIVE', readinessStatus: 'READY_FOR_INTERVIEW', contactabilityStatus: 'CONTACTABLE', operationalPhase: 'SUPPLYING', owner: manager, lastActivityAt: '2026-08-08T09:00:00.000Z', nextAction: 'Bổ sung hồ sơ COE', applicationCount: 1, hasActiveJourney: true, emailMasked: 'v***@example.com', phoneMasked: '09******05', source: 'Giới thiệu khách hàng', isPossibleDuplicate: false }),
  candidate({ id: 'candidate-02', code: 'UV-0002', name: 'Trần Quốc Bảo', industryLabels: ['Cơ khí chế tạo'], occupation: 'Kỹ thuật viên cơ khí', japaneseLevel: 'N4', recordStatus: 'ACTIVE', readinessStatus: 'NOT_READY', contactabilityStatus: 'UNKNOWN', operationalPhase: 'POTENTIAL', owner: recruiter, lastActivityAt: '2026-08-11T09:00:00.000Z', nextAction: 'Bổ sung số điện thoại', applicationCount: 0, hasActiveJourney: false, emailMasked: null, phoneMasked: null, source: 'Import bảng tính', isPossibleDuplicate: true }),
  candidate({ id: 'candidate-10', code: 'UV-0010', name: 'Nguyễn Thị Hạnh', industryLabels: ['Sản xuất'], occupation: 'Vận hành máy', japaneseLevel: 'N4', recordStatus: 'ARCHIVED', readinessStatus: 'NOT_READY', contactabilityStatus: 'DO_NOT_CONTACT', operationalPhase: 'POTENTIAL', owner: manager, lastActivityAt: '2026-07-30T09:00:00.000Z', nextAction: 'Đã lưu trữ', applicationCount: 0, hasActiveJourney: false, emailMasked: 'h***@example.com', phoneMasked: '09******10', source: 'Nguồn cũ', isPossibleDuplicate: false }),
  candidate({ id: 'candidate-11', code: 'UV-0011', name: 'Đỗ Mai Lan', industryLabels: ['Công nghệ thông tin'], occupation: 'QA Engineer', japaneseLevel: 'N2', recordStatus: 'ACTIVE', readinessStatus: 'READY_FOR_INTERVIEW', contactabilityStatus: 'CONTACTABLE', operationalPhase: 'SUPPLIED', owner: coordinator, lastActivityAt: '2026-07-18T09:00:00.000Z', nextAction: 'Theo dõi sau tiếp nhận', applicationCount: 1, hasActiveJourney: false, emailMasked: 'd***@example.com', phoneMasked: '09******11', source: 'Đối tác tuyển dụng', isPossibleDuplicate: false })
];
