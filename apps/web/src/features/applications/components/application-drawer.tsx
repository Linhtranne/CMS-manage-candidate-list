...
export function ApplicationDrawer({ applicationId, open, onClose }: { applicationId?: string; open: boolean; onClose: () => void }) {
  ...
  const attendanceInterview = application?.interviews.find((item) => item.id === selectedInterviewId);
