...
const views = [['all', 'Tất cả'], ['needs-action', 'Cần xử lý'], ['unmatched', 'Chưa ghép'], ['waiting-candidate', 'Chờ ứng viên'], ['waiting-internal', 'Chờ nội bộ'], ['sent', 'Đã gửi'], ['received', 'Đã nhận'], ['completed', 'Đã hoàn tất'], ['failed', 'Gửi thất bại']] as const;
